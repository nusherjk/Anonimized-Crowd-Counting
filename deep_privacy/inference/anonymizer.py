...
class Anonymizer:
    ...
    def anonymize_image_with_return(self,
        ...
        for image_idx, (anon_im) in enumerate(anonymized_images):
            ...
            # Will only send One picture
            #Will Require all the picture
